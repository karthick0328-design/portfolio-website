  ...
  projects: [
    {
      ...
      shortTitle: "AI-Voice",
      subtitle: "Intelligent Voice AI & Speech Synthesis Platform",
      ...
      toolsAndFeaturesText: "Voice AI, Real-time Speech Synthesis, Web Speech API, Tailwind CSS",
      features: [
      ...
      mockupHeadline: "Rapidly Create Real-Time Voice AI with AI-Voice",
      mockupHighlight: "Real-Time Voice AI",
      mockupPills: [
        { icon: "🔊", text: "Human-like Interaction" },
        { icon: "🎙️", text: "Speech-to-Text Recognition" },
        { icon: "⚡", text: "Real-Time Audio Waves" }
      ],
      badgeText: "Free Interactive Web Speech Engine",
      dashboardUser: "Karthick",
      supportAgent: "Voice AI",
      navBrand: "AIVoice.ai",
      ...
      bubbleColor: "text-purple-600 dark:text-purple-400",
      brandColor: "text-purple-600 dark:text-purple-400",
      pillBadge: "bg-purple-600",
      numberColor: "text-purple-400/50 dark:text-purple-500/40",
    ...
    },
    {
      ...
      accentBadge: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/30",
      btnGradient: "from-cyan-500 via-blue-600 to-indigo-600 hover:from-cyan-400 hover:to-indigo-500",
      bubbleColor: "text-cyan-600 dark:text-cyan-400",
      brandColor: "text-cyan-600 dark:text-cyan-400",
      pillBadge: "bg-cyan-600",
      numberColor: "text-cyan-400/50 dark:text-cyan-500/40",
    ...
    },
    {
      ...
      mockupHeadline: "Automate Growth & SEO with MarketAI Pro",
      mockupHighlight: "MarketAI Pro",
      mockupPills: [
      ...
      numberColor: "text-emerald-400/50 dark:text-emerald-500/40",
      github: "https://github.com/karthick0328-design",
    ...
    },
    {
      ...
      bubbleColor: "text-amber-600 dark:text-amber-400",
      brandColor: "text-amber-600 dark:text-amber-400",
      pillBadge: "bg-amber-600",
      numberColor: "text-amber-400/50 dark:text-amber-500/40",
      github: "https://github.com/karthick0328-design",
      live: "https://karthick-portfolio-six.vercel.app/",
    ...
    },
    {
      ...
      bubbleColor: "text-rose-600 dark:text-rose-400",
      brandColor: "text-rose-600 dark:text-rose-400",
      pillBadge: "bg-rose-600",
      numberColor: "text-rose-400/50 dark:text-rose-500/40",
      github: "https://github.com/karthick0328-design",
      live: "https://karthick-portfolio-six.vercel.app/",
