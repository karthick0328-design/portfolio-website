      ...
      <div className="p-6 md:p-7 flex-grow flex flex-col relative z-10 bg-transparent">
        ...
        <div className="pt-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-2xl bg-zinc-900 dark:bg-zinc-800 hover:bg-zinc-800 dark:hover:bg-zinc-700 text-white font-semibold text-xs border border-zinc-800 dark:border-zinc-700 hover:border-blue-500 transition-all duration-300 shadow-md active:scale-95 group/btn"
            title="View Source on GitHub"
          >
